...
public class DrawChart {
    ...
    private static List<Double> getTemperaturesFromServer() {  //получение температуры с сервера
    ...
    private static void drawChart(List<Double> temperatures) {  //схема изменения температура
